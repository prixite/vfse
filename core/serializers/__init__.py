...
class UserSerializer(serializers.ModelSerializer):
    ...
    documentation_url = serializers.CharField(source='profile.documentation_url',read_only=True)
    fse_accessible = serializers.CharField(source='profile.fse_accessible',read_only=True)
    audit_enabled = serializers.CharField(source='profile.audit_enabled',read_only=True)
    can_leave_notes= serializers.CharField(source='profile.can_leave_notes',read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            "organizations",
            "phone",
            'fse_accessible','audit_enabled','can_leave_notes','view_only','is_one_time','documentation_url',
            "role",
            "manager",
        ]
