...
from core.models import SystemImage, ManufacturerImage


@admin.register(models.UserModality)
class UserModalityAdmin(admin.ModelAdmin):
    list_display = ("user", "modality",)
...
class UserHealthNetworkAdmin(admin.ModelAdmin):
    list_display = ("user", "health_network",)
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ("modality", "manufacturer", "name",)


@admin.register(models.Documentation)
class DocumentationAdmin(admin.ModelAdmin):
    list_display = ("product", "documenation",)


@admin.register(models.Notes)
class NotesAdmin(admin.ModelAdmin):
    list_display = ("system", "author", "note",)


@admin.register(models.Seat)
class SeatAdmin(admin.ModelAdmin):
    list_display = ("system", "organization",)
