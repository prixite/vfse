...
class SiteFactory(factory.django.DjangoModelFactory):
    ...
    def users(obj, create, extracted, **kwargs):
        ...
        models.UserSite.objects.bulk_create(
            models.UserSite(user=user, site=obj,organization=obj.organization) for user in extracted or []
        )
...
class SystemFactory(factory.django.DjangoModelFactory):
    ...
    def users(obj, create, extracted, **kwargs):
        ...
        models.UserSystem.objects.bulk_create(
            models.UserSystem(user=user, system=obj,organization=obj.site.organization) for user in extracted or []
        )
