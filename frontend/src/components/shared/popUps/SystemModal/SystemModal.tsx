                ...
                generalInfoArray.map((item)=>(
                  <Grid item xs={6}>
                    <div className="info-section">
                      ...
                      />
                      {  item?.showError && item.error ? <p className="errorText">{item?.error}</p> : '' }
                    </div>
                  </Grid>
                ))
               }
                  ...
                  <Grid item xs={12}>
                    <div className="info-section">
                      ...
                      <TextField
                        ...
                        onChange={(e)=> {setSystemContactInfo(e.target.value)}}
                      />
                    </div>
                  </Grid>
            </Grid>
                  ...
                  <Grid item xs={12}>
                    <div className="info-section">
                      ...
                      <TextField
                        ...
                        placeholder=""
                        value={grafanaLink}
                        onChange={(e)=> {setGrafanaLink(e.target.value)}}
                      />
                ...
                <Grid container spacing={2} style={{ marginBottom: "5px" }}>
                  <Grid item xs={6}>
                    ...
                    <TextField
                      ...
                      placeholder=""
                      value={risIp}
                      onChange={(e)=> {setRisIp(e.target.value)}}
                    />
                    { risIpError ? <p className="errorText">{risIpError}</p> : '' }
                  </Grid>
                  <Grid item xs={6}>
                    ...
                    <TextField
                      ...
                      placeholder=""
                      value={risTitle}
                      onChange={(e)=> {setRisTitle(e.target.value)}}
                    />
                    { risTitleError ? <p className="errorText">{risTitleError}</p> : '' }
                  </Grid>
                  <Grid item xs={6}>
                    ...
                    <TextField
                      ...
                      type="number"
                      value={risPort}
                      onChange={(e)=> {setRisPort(e.target.value)}}
                    />
                    { risPortError ? <p className="errorText">{risPortError}</p> : '' }
                  </Grid>
                  <Grid item xs={6}>
                    ...
                    <TextField
                      ...
                      placeholder=""
                      value={risAE}
                      onChange={(e)=> {setRisAE(e.target.value)}}
                    />
                    { risAeError ? <p className="errorText">{risAeError}</p> : '' }
                  </Grid>
                </Grid>
              </div>
              <div className="box-heading">
                  ...
                  <Grid container spacing={2} style={{ marginBottom: "5px" }}>
                    <Grid item xs={6}>
                      ...
                      <TextField
                        ...
                        placeholder=""
                        value={dicIP}
                        onChange={(e)=> {setDicIP(e.target.value)}}
                      />
                      { dicIpError ? <p className="errorText">{dicIpError}</p> : '' }
                    </Grid>
                    <Grid item xs={6}>
                      ...
                      <TextField
                        ...
                        placeholder=""
                        value={dicTitle}
                        onChange={(e)=> {setDicTitle(e.target.value)}}
                      />
                      { dicTitleError ? <p className="errorText">{dicTitleError}</p> : '' }
                    </Grid>
                    <Grid item xs={6}>
                      ...
                      <TextField
                        ...
                        value={dicPort}
                        type="number"
                        onChange={(e)=> {setDicPort(e.target.value)}}
                      />
                      { dicPortError ? <p className="errorText">{dicPortError}</p> : '' }
                    </Grid>
                    <Grid item xs={6}>
                      ...
                      <TextField
                        ...
                        value={dicAE}
                        placeholder=""
                        onChange={(e)=> {setDicAE(e.target.value)}}
                      />
                      { dicAeError ? <p className="errorText">{dicAeError}</p> : '' }
                    </Grid>
                  </Grid>
                </div>
              </div>
                  ...
                  <Grid container spacing={2} style={{ marginBottom: "5px" }}>
                    <Grid item xs={6}>
                      ...
                      <TextField
                        ...
                        placeholder=""
                        value={mriHelium}
                        onChange={(e)=> {setMriHelium(e.target.value)}}
                      />
                      { mriHeliumError ? <p className="errorText">{ mriHeliumError }</p> : '' }
                    </Grid>
                    <Grid item xs={6}>
                      ...
                      <TextField
                        ...
                        placeholder=""
                        value={mriMagnet}
                        onChange={(e)=> {setMriMagnet(e.target.value)}}
                      />
                      { mriMagnetError ? <p className="errorText">{ mriMagnetError }</p> : '' }
                    </Grid>
                  </Grid>
                </div>
              </div>
