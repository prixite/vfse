...
const ArticleDescriptionCard = ({overview, description, startGuide} : ArticleDescription) => {
  return (
    <div  className="article-description">
       ...
       <h1 className="heading" style={{margin: '18px 0'}}>Getting started</h1>
       <p className="description">{description}</p>
       <h1 className="heading" style={{margin: '18px 0'}}>Start guide</h1>
