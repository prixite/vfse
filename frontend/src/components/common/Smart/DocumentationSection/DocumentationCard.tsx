...
const DocumentationCard = ({doc,documentationLink,openDropDown} :DocumentationCardProp) => {
  return (
    <div className="DocumentationCard">
        <div className="system">
            <h3 className="name">{doc?.model}</h3>
            <img src={EditLogo} onClick={(e)=>openDropDown(e,doc?.id,doc?.name)}/>
        </div>
