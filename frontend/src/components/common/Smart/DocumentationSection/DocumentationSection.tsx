          ...
          <TopTableFilters/>
            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
                ...
                <TableRow>
                    ...
                    <StyledTableCell align="right">DOCUMENTATION LINK</StyledTableCell>
                ...
                {rows.map((row, index) => (
                    <StyledTableRow key={index}>
                        ...
                        <StyledTableCell align="right">{renderModalities(['MRI', 'CRM', 'MRI-2'])}</StyledTableCell>
                        <StyledTableCell align="right">{documentationLink('www.doclink.com/ertghjhas/systemname')}</StyledTableCell>
