...
const ConfirmationModal = ({open,handleClose,handleDeleteOrganization,name}) => {
    ...
    return (
      ...
      >
        <DialogContent  className="ConfirmationModal__Content">
          ...
          <DialogContentText className="ClientName">
            {name}
          </DialogContentText>
        </DialogContent>
        <DialogActions className="ConfirmationModal__Actions">
          <Button className="btnModal" onClick={handleClose}>{noButton}</Button>
