...
import { Comment, VfseCommentsRepliesListApiResponse } from "@src/store/reducers/generated";
...
function TopicReply({
    ...
    const { data: repliesData = [], isLoading: isRepliesLoading, refetch} = //remove  Refetch
  ...
  return (<Box className="TopicReplyView">
   {/* Replied start  */}
