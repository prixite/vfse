...
const ClientCard = ({id,logo,name ,deleteOrganization , refetch ,row ,setOpen,setOrganization} : ClientCardProps) => {
    ...
    return (
        <Box component="div" className="ClientCard">
            <div className="ClientCard__Header">
                ...
                <div>
                    <MoreVertIcon id="client-options-button" className="dropdown" onClick={handleClick} />
                    <Menu
